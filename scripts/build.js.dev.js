 ...
 * @since 0.0.0
 */
function _doUMD(head, core, foot, suffix, done) {
  const d1 = new Date();
  process.stdout.write(`Starting '\x1b[36mdo:umd:${suffix}\x1b[89m\x1b[0m'...\n`);
 ...
 * @since 0.0.0
 */
function _doLib(source, suffix, done) {
  ...
  _doUMD(head, src, foot, suffix, _next);
  _doES6(head, src, foot, suffix, _next);
}
